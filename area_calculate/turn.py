...
# circles= cv2.HoughCircles(canny,cv2.HOUGH_GRADIENT,1,50,param1=80,param2=30,minRadius=15,maxRadius=20)
# # print(len(circles[0]))
...
# circles = cv2.HoughCircles(cimg, cv2.HOUGH_GRADIENT, 1, 20,param1=100, param2=100, minRadius=0, maxRadius=0)
